...
public class Main {
	...
	private static final void configure(){
		...
		JLabel ver = new JLabel("<html><center><i>Version: v7.3, latest version: <font color=gray>loading</font><br>"
		...
		new Thread(()->{
			...
			ver.setText("<html><center><i>Version: v7.3, latest version: " + (version == null ? "unknown :(" : version) + "<br>"
